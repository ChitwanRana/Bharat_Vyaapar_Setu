...
import "./SocialDetails.css"; // Assuming the CSS below is saved here

const SocialDetails = () => {
  const handleSocialClick = (url) => {
    window.open(url, "_blank"); // Replace with the respective social media links
  };

  return (
    <div className="social-details-container">
      <div
        className="social-details-button"
