...
const SignIn = ({ setIsLoggedIn, checkLoginStatus }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://bharat-vyaapar-setu-e522.onrender.com/auth/login", {
        method: "POST",
        headers: {
                ...
                <div className="d-flex gap-3 flex-column w-100">
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 16 16"
                    >
                      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.194-3.131 3.02-3.131.876 0 1.798.157 1.798.157v1.98H10.63c-.996 0-1.306.621-1.306 1.258V8.05h2.218l-.354 2.325H9.324V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                    </svg>
                    <span className="ms-2 fs-6 flex-grow-1">
